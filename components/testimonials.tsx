      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Nous proposons des solutions web innovantes qui permettent aux
            entreprises de créer des environnements de travail plus efficaces et
            plus agréables, partout dans le monde
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mx-auto text-center">Coming soon</div>
          {/* Cards */}
          <div
