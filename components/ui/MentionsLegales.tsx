export const MentionsLegales = () => {
  return (
    <div className="px-12 py-12">
      <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 pt-8 font-nacelle text-l font-semibold text-transparent md:text-xl">
        Définitions
      </h2>
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> met à disposition
        des Clients :
      </p>
      <p className="text-indigo-200/65 pt-2">
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        détenues par <a href="https://volpio.com">https://volpio.com</a> pour la
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        site internet <a href="https://volpio.com">https://volpio.com</a>{' '}
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi:
      </p>
      <p className="text-indigo-200/65 pt-2">
        <strong>Propriétaire</strong> : SARL Volpio Capital social de 2000€
        Numéro de TVA: FR85891495467 – 40 rue des Princes de Wagram 94520
        Mandres les Roses
        <br />
        <strong>Responsable publication</strong> : Florent Pellegrin –
        florent.pellegrin@volpio.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Florent PELLEGRIN –
        florent.pellegrin@volpio.com
        <br />
        <strong>Hébergeur</strong> : Netlify – 2325 3rd Street, Suite 215 CA
        94107 San Francisco +1 844-899-7312
        <br />
        <strong>Délégué à la protection des données</strong> : Florent PELLEGRIN
        – florent.pellegrin@volpio.com
        <br />
      </p>
      <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 pt-8 font-nacelle text-l font-semibold text-transparent md:text-xl">
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> implique
        ...
        <a href="https://volpio.com">https://volpio.com</a>
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a>, qui s’efforcera
        alors de communiquer préalablement aux utilisateurs les dates et heures
        de l’intervention. Le site web{' '}
        <a href="https://volpio.com">https://volpio.com</a> est mis à jour
        régulièrement par <a href="https://volpio.com">https://volpio.com</a>{' '}
      ...
      <p className="text-indigo-200/65 pt-2">
        Le site internet <a href="https://volpio.com">https://volpio.com</a> a
        pour objet de fournir une information concernant l’ensemble des
        activités de la société.
        <a href="https://volpio.com">https://volpio.com</a> s’efforce de fournir
        sur le site <a href="https://volpio.com">https://volpio.com</a> des
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> sont données à titre
        indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site{' '}
        <a href="https://volpio.com">https://volpio.com</a> ne sont pas
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> est hébergé chez un
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> et l’hébergeur ne
        pourront être tenus responsables en cas de dysfonctionnement du réseau
        Internet, des lignes téléphoniques ou du matériel informatique et de
        téléphonie lié notamment à l’encombr/ement du réseau empêchant l’accès
        au serveur.
      </p>
      <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 pt-8 font-nacelle text-l font-semibold text-transparent md:text-xl">
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> est propriétaire des
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> agit en tant
        qu’éditeur du site. <a href="https://volpio.com">https://volpio.com</a>{' '}
        est responsable de la qualité et de la véracité du Contenu qu’il publie.{' '}
      </p>
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> ne pourra être tenu
        responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site internet{' '}
        <a href="https://volpio.com">https://volpio.com</a>, et résultant soit
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> ne pourra également
        ...
        site <a href="https://volpio.com">https://volpio.com</a>. Des espaces
        interactifs (possibilité de poser des questions dans l’espace contact)
        sont à la disposition des utilisateurs.{' '}
        <a href="https://volpio.com">https://volpio.com</a> se réserve le droit
        ...
        cas échéant, <a href="https://volpio.com">https://volpio.com</a> se
      ...
      <h3 className="mb-1 font-nacelle text-[1rem] pt-4 font-semibold text-gray-200">
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        responsable du traitement des Données Personnelles est : Volpio.{' '}
        <a href="https://volpio.com">https://volpio.com</a>est représenté par
        Florent Pellegrin, son représentant légal
      </p>
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> traite des Données
        Personnelles, <a href="https://volpio.com">https://volpio.com</a> prend
        ...
        lesquelles <a href="https://volpio.com">https://volpio.com</a> les
        traite.
      </p>
      <h3 className="mb-1 font-nacelle text-[1rem] pt-4 font-semibold text-gray-200">
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> est susceptible de
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://volpio.com">https://volpio.com</a> : adresse email{' '}
        </li>
        <li>
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> ne commercialise pas
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        de <a href="https://volpio.com">https://volpio.com</a> disposent des
        droits suivants :{' '}
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          et de choisir à qui{' '}
          <a href="https://volpio.com">https://volpio.com</a> devra communiquer
          (ou non) ses données à un tiers qu’ils aura préalablement désigné
        </li>
      </ul>
      <p className="text-indigo-200/65 pt-2">
        Dès que <a href="https://volpio.com">https://volpio.com</a> a
        connaissance du décès d’un Utilisateur et à défaut d’instructions de sa
        part, <a href="https://volpio.com">https://volpio.com</a> s’engage à
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> utilise ses Données
        Personnelles, demander à les rectifier ou s’oppose à leur traitement,
        l’Utilisateur peut contacter{' '}
        <a href="https://volpio.com">https://volpio.com</a> par écrit à
        l’adresse suivante :{' '}
      </p>
      Volpio – DPO, Florent PELLEGRIN <br />
      40 rue des Princes de Wagram 94520 Mandres les Roses.
      <p className="text-indigo-200/65 pt-2">
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
        souhaiterait que <a href="https://volpio.com">https://volpio.com</a>{' '}
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> par la loi,
        notamment en matière de conservation ou d’archivage des documents.
        Enfin, les Utilisateurs de{' '}
        <a href="https://volpio.com">https://volpio.com</a> peuvent déposer une
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> s’interdit de
        ...
        <a href="https://volpio.com">https://volpio.com</a> reste libr/e du
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> s’engage à prendre
        ...
        à la connaissance de <a href="https://volpio.com">https://volpio.com</a>
        ...
        <a href="https://volpio.com">https://volpio.com</a> ne collecte aucune "
        données sensibles ".
      </p>
      <p className="text-indigo-200/65 pt-2">
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de <a href="https://volpio.com">https://volpio.com</a> et des
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> sont principalement
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> n'est publiée à
        ...
        <a href="https://volpio.com">https://volpio.com</a> et de ses droits
        ...
        du site <a href="https://volpio.com">https://volpio.com</a>.
      </p>
      <h3 className="mb-1 font-nacelle text-[1rem] pt-4 font-semibold text-gray-200">
        Sécurité
      </h3>
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> utilise des réseaux
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a>prend toutes les
      ...
      <p className="text-indigo-200/65 pt-2">
        Le site <a href="https://volpio.com">https://volpio.com</a> contient un
        certain nombr/e de liens hypertextes vers d’autres sites, mis en place
        avec l’autorisation de{' '}
        <a href="https://volpio.com">https://volpio.com</a>. Cependant,
        <a href="https://volpio.com">https://volpio.com</a> n’a pas la
      ...
      <p className="text-indigo-200/65 pt-2"></p>
      <h3 className="mb-1 font-nacelle text-[1rem] pt-4 font-semibold text-gray-200">
        9.1. " COOKIES "
      </h3>
      <p className="text-indigo-200/65 pt-2">
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> d’améliorer le
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> informe
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        être le cas lorsque <a href="https://volpio.com">https://volpio.com</a>{' '}
      ...
      <p className="text-indigo-200/65 pt-2">
        Le cas échéant, <a href="https://volpio.com">https://volpio.com</a>{' '}
        ...
        par <a href="https://volpio.com">https://volpio.com</a>, résultant (i)
        du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour{' '}
        <a href="https://volpio.com">https://volpio.com</a> d’enregistrer ou de
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> pourra en outre
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> ou dans son
        ...
        de <a href="https://volpio.com">https://volpio.com</a>, Twitter,
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a>. À tout moment,
        l’Utilisateur peut néanmoins revenir sur son consentement à ce que{' '}
        <a href="https://volpio.com">https://volpio.com</a> dépose ce type de
        cookies.
      </p>
      <h3 className="mb-1 font-nacelle text-[1rem] pt-4 font-semibold text-gray-200">
      ...
      <p className="text-indigo-200/65 pt-2">
        <a href="https://volpio.com">https://volpio.com</a> peut employer
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> d’évaluer les
        réponses des visiteurs face au Site et l’efficacité de ses actions (par
        exemple, le nombr/e de fois où une page est ouverte et les informations
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a>, et fournir d’autres
      ...
      <p className="text-indigo-200/65 pt-2">
        ...
        <a href="https://volpio.com">https://volpio.com</a> est soumis au droit
        français. En dehors des cas où la loi ne le permet pas, il est fait
        attribution exclusive de juridiction aux tribunaux compétents de Créteil
      </p>
    </div>
  )
}
